  ...
  return (
    <div name="home" className="w-full h-screen bg-[#222020] color-wite">
      <div className="max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full">
        ...
        <h2 className=" text-4xl font-bold text-[#756c6c] sm:text-6xl ">
          I'm frontend developer
        </h2>
        <p className="text-[#605555] py-5 sm:text-2xl max-w-[700px] ">
          creative frontend devoloper self motivated team player // should add
          text
        </p>
        <div>
